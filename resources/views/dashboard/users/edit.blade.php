  ...
  <div class="col-lg-5">
      <main class="form-registration">
          <form action="/dashboard/users/{{ $user->id }}" method="post">
            ...
            <div class="form-floating">
              <input type="email" name="email" class="form-control @error ('email')is-invalid @enderror" id="email" placeholder="name@example.com" value="{{ old('email', $user->email) }}">
            ...
            <button class="w-100 btn btn-lg btn-primary mt-4" type="submit">Edit</button>
